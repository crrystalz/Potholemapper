        ...
        for filename in filenames:
            ...
            if filename.endswith("-front.mp4"):
                ...
                try:
                    ...
                    print(
                        f"Error copying file from {source_file_path} to {dest_file_path}: {e}"
                    )
...
def _copy_geotagged_frames(mapillary_sampled_video_frames_dir, geotagged_frames_dir):
    ...
    if not os.path.exists(mapillary_sampled_video_frames_dir):
        raise ValueError(
            f"Source directory {mapillary_sampled_video_frames_dir} does not exist"
        )
...
def geotag(dashcam_video_dir, working_dir, gpx_filepath):
    mapillary_sampled_video_frames = os.path.join(
        working_dir, "mapillary_sampled_video_frames"
    )
...
# print(_has_exif_loc("/home/saswat/Potholemapper/raw_videos/mapillary_sampled_video_frames/2023-09-23_19-04-25-front.mp4/2023-09-23_19-04-25-front_NA_000084.jpg"))
